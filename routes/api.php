...
// AC Chill - OTP Authentication Routes
Route::post('verify-email-otp', [API\User\UserController::class, 'verifyEmailOTP']);
Route::post('resend-email-otp', [API\User\UserController::class, 'resendEmailOTP']);
Route::post('verify-reset-otp', [API\User\UserController::class, 'verifyResetOTP']);
Route::post('reset-password', [API\User\UserController::class, 'resetPasswordWithOTP']);
