...
<div class="iq-blog blog-standard position-relative">
    <div class="blog-image position-relative">
        <a :href="`${baseUrl}/blog-details/${blogId}`" class="d-block overflow-hidden">
    ...
    <div class="iq-post-details position-relative">
        <div class="blog-meta-data bg-light rounded">
            <div class="d-flex align-items-center justify-content-center gap-3">
                ...
                <div class="blog-categories">
                    <ul class="list-inline m-0 d-flex align-items-center gap-4">
                        <li>
                            <span>{{blogCategory1}}</span>
                        </li>
                        <li>
                            <span>{{blogCategory2}}</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="blog-title text-start mb-2">
            <a :href="`${baseUrl}/blog-details/${blogId}`">
                <h5 class="text-capitalize line-count-2">{{blogTitle}}</h5>
            </a>
        </div>

        <div class="iq-blog-meta-bottom d-flex align-items-center justify-content-between mt-5">
            <div class="author-block">
                <img :src="blogAuthImage" alt="blog-image"
                    class="img-fluid rounded-circle avatar-30 object-cover" loading="lazy">
                <span class="ps-1 fw-500 text-capitalize">{{blogAuthor}}</span>
            </div>
            <div class="iq-btn-container">
                <a class="btn btn-link p-0 text-capitalize" :href="`${baseUrl}/blog-details/${blogId}`">
                    {{ $t('landingpage.read_more') }}
...
defineProps({
    ...
    blogCategory1: {type:String ,default:''},
    viewNumbers: {type:Number ,default:0},
    blogPublishDate: {type:String ,default:''},
    blogCategory2: {type:String ,default:''},
    blogTitle: {type:String ,default:''},
    blogAuthor: {type:String ,default:''},
    blogAuthImage:{type:String ,default:''},
