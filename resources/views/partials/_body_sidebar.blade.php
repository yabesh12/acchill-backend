        ...
        $menu
            ->add(
                '<span>' .
                    ...
                    'Carts' .
                    '</span></span>',
                ['route' => 'cart-admin.index'],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="8" cy="21" r="1.5" stroke="currentColor" stroke-width="1.5"/>
<circle cx="18" cy="21" r="1.5" stroke="currentColor" stroke-width="1.5"/>
<path d="M2 3L3.5 3L5 3L7.5 15H18.5L21 6H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>',
            )
...
<div class="iq-sidebar sidebar-default">
    ...
    <div class="sidebar-scroll-native">
